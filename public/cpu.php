...
<div class="container-fluid chessheader">
        <div class="container text-center" style="background:none;">
            ...
            <button class="btn btn-default" onclick="window.open('https://en.wikipedia.org/wiki/Rules_of_chess'); window.location.href = 'https://en.wikipedia.org/wiki/Rules_of_chess'" target="_blank">Don't know what to do? See the rules</button>
        </div>
</div>
